...
static bool ParseDiagnosticArgs(DiagnosticOptions &Opts, ArgList &Args,
  ...
  // If no style options are specified, pretty-print diagnostics if color is
  // enabled, falling back to LLVM style if it's disabled.
  Opts.PrintedFormattingStyle = Opts.UseColor
